...
SET id_ref2 = 
    CASE 
        WHEN id_pers = 1 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 1) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 2 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 2) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 3 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 3) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 4 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 4) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 5 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 5) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 6 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 6) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 7 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 7) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 8 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 8) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 9 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 9) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 10 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 10) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 11 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 11) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 12 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 12) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 13 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 13) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 14 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 14) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 15 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 15) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 16 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 16) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 17 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 17) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 18 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 18) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 19 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 19) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 20 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 20) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 21 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 21) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 22 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 22) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 23 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 23) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 24 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 24) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 25 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 25) ORDER BY RAND() LIMIT 1) AS refuerzos)
        WHEN id_pers = 26 THEN (SELECT id_ref FROM (SELECT id_ref FROM reforcos WHERE id_ref NOT IN (
            SELECT id_ref1 FROM forza_brawler WHERE id _pers = 26) ORDER BY RAND() LIMIT 1) AS refuerzos)
    END
WHERE nivell >= 10;
